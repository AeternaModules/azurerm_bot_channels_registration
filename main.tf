data "azurerm_key_vault_secret" "developer_app_insights_api_key" {
  for_each     = { for k, v in var.bot_channels_registrations : k => v if v.developer_app_insights_api_key_key_vault_id != null && v.developer_app_insights_api_key_key_vault_secret_name != null }
